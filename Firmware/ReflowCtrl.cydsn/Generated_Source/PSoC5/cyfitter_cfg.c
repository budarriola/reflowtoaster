...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG1_CFG0), 0x09DEu);
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_FASTCLK_PLL_P), 0x0B26u);
...
uint8 CYXDATA * const CYCODE ADCMux__addrTable[8] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE ADCMux__maskTable[8] = {
	0x80u, 0x08u, 
	0x08u, 0x00u, 
	0x80u, 0x80u, 
	0x01u, 0x10u, 
...
void ADCMux_Set(uint8 channel)
{
	...
	{
		channel += channel;
		*ADCMux__addrTable[channel] |= ADCMux__maskTable[channel];
		channel++;
		*ADCMux__addrTable[channel] |= ADCMux__maskTable[channel];
	}
}
...
void ADCMux_Unset(uint8 channel)
{
	...
	{
		channel += channel;
		*ADCMux__addrTable[channel] &= (uint8)~ADCMux__maskTable[channel];
		channel++;
		*ADCMux__addrTable[channel] &= (uint8)~ADCMux__maskTable[channel];
	}
}
...
void cyfitter_cfg(void)
{
	...
	static const uint8 CYCODE BS_IOPINS0_7_VAL[] = {
		0x03u, 0x00u, 0x00u, 0x00u, 0x03u, 0x03u, 0x03u, 0x00u, 0x00u, 0x03u};
	...
	static const uint8 CYCODE BS_IOPINS0_1_VAL[] = {
		0x00u, 0x00u, 0x00u, 0x07u, 0x03u, 0x00u, 0x00u, 0x00u, 0x80u, 0x00u};
	...
	ClockSetup();
	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x40010612u, /* Base address: 0x40010600 Count: 18 */
			0x4001070Eu, /* Base address: 0x40010700 Count: 14 */
			...
			0x40011706u, /* Base address: 0x40011700 Count: 6 */
			...
			0x4001420Au, /* Base address: 0x40014200 Count: 10 */
