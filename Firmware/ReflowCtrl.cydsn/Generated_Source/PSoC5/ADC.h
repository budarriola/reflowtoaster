...
#define ADC_TC_Config_RESOLUTION         (20u )
#define ADC_TC_Config_INPUT_RANGE        (3u)
#define ADC_TC_Config_SRATE              (182u)
#define ADC_TC_Config_REFERENCE          (4u)
#define ADC_TC_Config_BUFFER_GAIN        (1u)
#define ADC_TC_Config_CONV_MODE          (0u)
#define ADC_TC_Config_INPUT_RANGE_VALUE  (7.5)
...
/* Default Config
* ADC_TC_Config Sample Rate: 182 Samples per Second
* ADC_TC_Config Conversion Mode: 0
* ADC_TC_Config Input Buffer Gain: 1
* ADC_TC_Config Reference: 4
* ADC_TC_Config Input Range: 3
* ADC_TC_Config Resolution: 20 bits
* ADC_TC_Config Clock: 3056326 Hz
*/

#define ADC_TC_Config_DEC_CR             (0x7Cu)
#define ADC_TC_Config_DEC_SR             (0x14u)
#define ADC_TC_Config_DEC_SHIFT1         (0x00u)
#define ADC_TC_Config_DEC_SHIFT2         (0x09u)
#define ADC_TC_Config_DEC_DIV            (0)
#define ADC_TC_Config_DEC_DR2            (0x7Fu)
#define ADC_TC_Config_DEC_DR2H           (0x00u)
#define ADC_TC_Config_DEC_DR1            (0x7Fu)
#define ADC_TC_Config_DEC_OCOR           (0x00u)
#define ADC_TC_Config_DEC_OCORM          (0x00u)
#define ADC_TC_Config_DEC_OCORH          (0x00u)
#define ADC_TC_Config_DEC_GVAL           (0x0Fu)
#define ADC_TC_Config_DEC_GCOR           (0x00u)
#define ADC_TC_Config_DEC_GCORH          (0x00u)
#define ADC_TC_Config_DEC_COHER          (0x01u)
#define ADC_TC_Config_DSM_CR0            (0x0Au)
#define ADC_TC_Config_DSM_CR1            (0x00u)
#define ADC_TC_Config_DSM_CR2            (0x7Au)
#define ADC_TC_Config_DSM_CR3            (0x00u)
#define ADC_TC_Config_DSM_CR4            (0x50u)
#define ADC_TC_Config_DSM_CR5            (0x07u)
#define ADC_TC_Config_DSM_CR6            (0x29u)
#define ADC_TC_Config_DSM_CR7            (0x00u)
#define ADC_TC_Config_DSM_CR8            (0x5Bu)
#define ADC_TC_Config_DSM_CR9            (0x5Eu)
#define ADC_TC_Config_DSM_CR10           (0x55u)
#define ADC_TC_Config_DSM_CR11           (0x5Au)
#define ADC_TC_Config_DSM_CR12           (0x00u)
#define ADC_TC_Config_DSM_CR13           (0x00u)
#define ADC_TC_Config_DSM_CR14           (0x02u)
#define ADC_TC_Config_DSM_CR15           (0x12u)
#define ADC_TC_Config_DSM_CR16           (0x28u)
#define ADC_TC_Config_DSM_CR17           (0xEAu)
#define ADC_TC_Config_DSM_REF0           (0x40u)
#define ADC_TC_Config_DSM_REF1           (0x00u)
#define ADC_TC_Config_DSM_REF2           (0x64u)
#define ADC_TC_Config_DSM_REF3           (0x00u)
#define ADC_TC_Config_DSM_DEM0           (0x04u)
#define ADC_TC_Config_DSM_DEM1           (0x00u)
#define ADC_TC_Config_DSM_MISC           (0x00u)
#define ADC_TC_Config_DSM_CLK            (0x18u)
#define ADC_TC_Config_DSM_BUF0           (0x01u)
#define ADC_TC_Config_DSM_BUF1           (0x01u)
#define ADC_TC_Config_DSM_BUF2           (0x00u)
#define ADC_TC_Config_DSM_BUF3           (0x0Au)
#define ADC_TC_Config_DSM_OUT0           (0x00u)
#define ADC_TC_Config_DSM_OUT1           (0x00u)
#define ADC_TC_Config_DSM_SW3            (0x40u)
#define ADC_TC_Config_CLOCKS_PER_SAMPLE  (0x4199u)
#define ADC_TC_Config_CLOCK_FREQ         (3056326u)
#define ADC_TC_Config_CP_CLOCK_FREQ      (12000000u)
#define ADC_TC_Config_REFERENCE_VOLTAGE  (1.2500)
#define ADC_TC_Config_COUNTS_PER_VOLT    (139810)
#define ADC_TC_Config_IDEAL_DEC_GAIN     (0x7F02u)
#define ADC_TC_Config_IDEAL_ODDDEC_GAIN  (0x8000u)

#define ADC_TC_Config_ALIGNMENT          (0u)
#define ADC_TC_Config_ADC_CLK_DIVIDER    (24u)
#define ADC_TC_Config_CP_CLK_DIVIDER     (6u)

/* Input and DAC Cap values in pF */
#define ADC_TC_Config_IPCAP1VALUE        (0x02B0u)
#define ADC_TC_Config_DACAPVALUE         (0x1000u)

/* Below defines are deprecated and should not be used. These are provided
*   just to keep the component backward compatible
*/
#define ADC_DEFAULT_SRATE                      ADC_TC_Config_SRATE
#define ADC_CLOCKS_PER_SAMPLE                  ADC_TC_Config_CLOCKS_PER_SAMPLE
#define ADC_DFLT_CLOCK_FREQ                    ADC_TC_Config_CLOCK_FREQ
#define ADC_REFERENCE_VOLTAGE                  ADC_TC_Config_REFERENCE_VOLTAGE
#define ADC_DFLT_COUNTS_PER_VOLT               ADC_TC_Config_COUNTS_PER_VOLT
#define ADC_DEFAULT_RESOLUTION                 ADC_TC_Config_RESOLUTION
#define ADC_DEFAULT_CONV_MODE                  ADC_TC_Config_CONV_MODE
#define ADC_DEFAULT_IDEAL_DEC_GAIN             ADC_TC_Config_IDEAL_DEC_GAIN
#define ADC_DEFAULT_RANGE                      ADC_TC_Config_RANGE
#define ADC_DEFAULT_RANGE_VALUE                ADC_TC_Config_RANGE_VALUE
#define ADC_DEFAULT_REFERENCE                  ADC_TC_Config_REFERENCE
#define ADC_DEFAULT_BUF_GAIN                   ADC_TC_Config_BUF_GAIN
#define ADC_TC_Config_BUF_GAIN           ADC_TC_Config_BUFFER_GAIN
#define ADC_TC_Config_RANGE              ADC_TC_Config_INPUT_RANGE
#define ADC_TC_Config_RANGE_VALUE        ADC_TC_Config_INPUT_RANGE_VALUE

/* Input and DAC Cap values in pF */
#define ADC_DEFAULT_IPCAP1VALUE                ADC_TC_Config_IPCAP1VALUE
#define ADC_DEFAULT_DACAPVALUE                 ADC_TC_Config_DACAPVALUE
#define ADC_DEFAULT_IDEAL_ODDDEC_GAIN          ADC_TC_Config_IDEAL_ODDDEC_GAIN
...
#define ADC_CFG2_ADC_CLK_DIVIDER    (118u)
#define ADC_CFG2_CP_CLK_DIVIDER     (18u)
...
#define ADC_CFG3_ADC_CLK_DIVIDER    (118u)
#define ADC_CFG3_CP_CLK_DIVIDER     (18u)
...
#define ADC_CFG4_ADC_CLK_DIVIDER    (118u)
#define ADC_CFG4_CP_CLK_DIVIDER     (18u)
