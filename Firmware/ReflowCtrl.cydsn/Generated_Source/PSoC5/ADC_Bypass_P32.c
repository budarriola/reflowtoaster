...
*
* \funcusage
*  \snippet ADC_Bypass_P32_SUT.c usage_ADC_Bypass_P32_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet ADC_Bypass_P32_SUT.c usage_ADC_Bypass_P32_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet ADC_Bypass_P32_SUT.c usage_ADC_Bypass_P32_Read  
*******************************************************************************/
...
* preferred ADC_Bypass_P32_Read() API because the 
* ADC_Bypass_P32_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet ADC_Bypass_P32_SUT.c usage_ADC_Bypass_P32_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: ADC_Bypass_P32_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use ADC_Bypass_P32_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - ADC_Bypass_P32_0_INTR       (First pin in the list)
    *  - ADC_Bypass_P32_1_INTR       (Second pin in the list)
    *  - ...
    *  - ADC_Bypass_P32_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet ADC_Bypass_P32_SUT.c usage_ADC_Bypass_P32_SetInterruptMode
    *******************************************************************************/
    void ADC_Bypass_P32_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & ADC_Bypass_P32_0_INTR) != 0u) 
		{ 
			 ADC_Bypass_P32_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet ADC_Bypass_P32_SUT.c usage_ADC_Bypass_P32_ClearInterrupt
    *******************************************************************************/
